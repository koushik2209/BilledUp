...
def msg_help(shop_name: str, days: int) -> str:
    return (
        f"📘 *BilledUp — How to use*\n\n"
        f"Just type naturally — I understand Telugu, Hindi & English!\n\n"
        f"*📄 Create a bill:*\n"
        f"_shirt 500 pant 600 customer Ravi_\n\n"
        f"*✅ Confirm or cancel:*\n"
        f"_yes_ or _no_\n\n"
        f"*✏️ Edit your bill:*\n"
        f"_\"remove pant\"_\n"
        f"_\"change shirt price to 450\"_\n"
        f"_\"add charger 299\"_\n"
        f"_\"customer name is Suresh\"_\n\n"
        f"*💰 Discounts:*\n"
        f"_\"10% off\"_ or _\"discount 50 rupees\"_\n\n"
        f"*🔄 Returns:*\n"
        f"_\"return shirt 500 Ravi\"_\n\n"
        f"*📊 Reports:*\n"
        f"_\"today's sales\"_\n"
        f"_\"gst report\"_\n"
        f"_\"last 5 bills\"_\n\n"
        f"*🔁 Repeat last bill:*\n"
        f"_\"same as last bill\"_\n\n"
        f"*⚙️ Fix GST rate:*\n"
        f"_\"shirt gst 5\"_\n\n"
        f"*📦 My saved items:*\n"
        f"_myitems_\n\n"
        f"Trial days left: {days}\n\n"
        f"_Just talk to me like your assistant — I'll understand_ 🤝\n"
        f"_BilledUp — Bill smarter. Grow faster._"
    )
